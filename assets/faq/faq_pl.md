...
Takers mogą zarejestrować się w kilku kanałach komunikacyjnych (SimpleX, Matrix), aby otrzymywać powiadomienia o nowych ofertach.
...
Jeśli obie strony sygnalizują konflikt, Maker musi dostarczyć dowody, że płatność BLIK została pobrana z jego konta bankowego, będzie to rozwiązane ręcznie przez człowieka odpowiedzialnego za koordynatora. Niedostarczenie takich dowodów spowoduje, że Taker nie otrzyma Bitcoin, a po 48h sats wrócą do Maker.
